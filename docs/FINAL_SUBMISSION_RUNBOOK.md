> Historical fixture-era runbook. For the current Gmail/Strands implementation and actual deployment limits, use README.md and docs/ARCHITECTURE.md. Revalidate URLs and claims before submission.
